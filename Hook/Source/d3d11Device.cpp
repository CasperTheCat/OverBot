...
D3D11CustomDevice::D3D11CustomDevice(HookCommunications *net, ID3D11Device* dev, ID3D11Device*** ret)
{
	m_d3dDevice = dev;
	*ret = &m_d3dDevice;
	m_net = net;
...
D3D11CustomDevice::D3D11CustomDevice(HookCommunications *net, ID3D11Device* dev)
{
    m_d3dDevice = dev;
	m_net = net;
}
